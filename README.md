...
Folder [**src**](https://github.com/parthian-sterlet/minimax/tree/main/src) contains the [major](https://github.com/parthian-sterlet/minimax/blob/main/src/minimax.cpp) and some supporting C++ source code files.  
...
Folder [**examples**](https://github.com/parthian-sterlet/minimax/tree/main/bin/examples) contains files required as the functional examples of the tool.
...
3. input file - list of all Mtot motif names for the input library (for [Jaspar](https://jaspar.elixir.no/) these are TF names, for [Hocomoco(https://hocomoco.autosome.org/) - motif IDs), this list includes Mtot motifs, Mtot is total number of motifs in the input library. Currently, for  _H. sapiens_ / _M.musculus_, _A. thaliana_ and _D. melanogaster_ these numbers are 1595/1245 ([Hocomoco v14](https://hocomoco14.autosome.org/)), 740 ([Jaspar Plants](https://jaspar.elixir.no/), filtered for -Log<sub>10</sub>(ERR) > 3.6) and 239 {238 ([Jaspar Insects](https://jaspar.elixir.no/), filtered for -Log<sub>10</sub>(ERR) > 3.6) + 1 ([Hocomoco v14](https://hocomoco14.autosome.org/), TBP)}. See examples for [_H. sapiens_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/namemot_hcmc1595), [_A. thaliana_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/name_jaspar742) and [_D. melanogaster_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/name_jaspar238_tbp), this list includes Mtot motifs.
4. input file - list of all Mtot motif class/family names for the input library. One unique short description is required. See examples for [_H. sapiens_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/nameclass_hcmc1595), [_A. thaliana_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/name_class742) and [_D. melanogaster_](https://github.com/parthian-sterlet/minimax/blob/main/examples/rnaseq/name_class238_tbp), this list includes Mtot motifs.
...
- ChIP-seq data for mouse STAT6 TF, [GSM2845664](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM2845664) (BMDM cells, 1h IL4 treatment), [chipseq_com_line](https://github.com/parthian-sterlet/minimax/blob/main/run/chipseq_com_line), applied for 14 morifs derived from de novo motif search by [STREME](https://doi.org/10.1093/bioinformatics/btab203) tool
-  RNA-seq data on stress and neuronal activity for drosophila [E-MTAB-9805](https://www.ebi.ac.uk/gxa/experiments/E-MTAB-9805/Results), [rnaseq_com_line](https://github.com/parthian-sterlet/minimax/blob/main/run/rnaseq_com_line), applied for the motif library [Jaspar Insects](https://jaspar.elixir.no/) (see above).
