...
4. input file - list of motif class or family name (one unique short description is required, see examples for _H. sapiens_, _A. thaliana_ and _D. melanogaster_), this list includes Mtot motifs.
