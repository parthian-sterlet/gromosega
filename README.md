...
- ChIP-seq data: [comnamd_line example](https://github.com/parthian-sterlet/GroMoSeGA/blob/main/run/chipseq_com_line) for ChIP-seq data [GSM2845664](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM2845664) for _M.musculus_ target TF STAT6 in bone marrow-derived macrophage (BMDM) cells differentiated in the presence of MCSF (Macrophage Colony-Stimulating Factor) and treated (1h) with interleukin-4 (IL-4) cytokine. _De novo_ motif search tool [STREME](https://doi.org/10.1093/bioinformatics/btab203) applied for [2500 tops-scoring ChIP-seq peaks](https://github.com/parthian-sterlet/GroMoSeGA/blob/main/examples/chipseq/GSM2845664_BMDM_1hIL4_STAT6_mm10.fa) vs. [random genome loci derived by AntiNoise tool](https://github.com/parthian-sterlet/GroMoSeGA/blob/main/examples/chipseq/GSM2845664_BMDM_1hIL4_STAT6_mm10_gb.fa) revealed 14 motifs. GroMoseGA was applied for these motifs and these forground/background sequence sets.
-  RNA-seq data: [omnamd_line example](https://github.com/parthian-sterlet/minimax/blob/main/run/rnaseq_com_line) illustrates RNA-seq data [E-MTAB-9805](https://www.ebi.ac.uk/gxa/experiments/E-MTAB-9805/Results) on stress and neuronal activity for _D. melanigaster_. GroMoseGA was applied for applied for the motif library [Jaspar Insects](https://jaspar.elixir.no/), down-regulated DEGs and not-DEGs were selected by criteria described above for RNA-seq data analysis.
